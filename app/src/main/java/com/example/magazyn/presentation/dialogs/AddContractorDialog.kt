...
fun AddContractorDialog(
    onAddContractor: (String, String, String) -> Unit,
    onCloseDialog: () -> Unit,
    ...
    var contractorUid by remember { mutableStateOf("") }
                    ...
                    Button(
                        onClick = {
                            if (contractorName.isNotBlank() && contractorSymbol.isNotBlank()) {
                                onAddContractor(contractorName, contractorSymbol, contractorUid)
                                onCloseDialog()
                            }
                        }
                    ) {
